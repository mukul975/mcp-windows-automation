...
# ==============================================================================
# APP WINDOW CONTROL COMMANDS
# ==============================================================================

@mcp.tool()
async def spotify_open_app() -> str:
    """Launch Spotify application"""
    try:
        await open_app_with_url("spotify")
        return "✅ Spotify: Application launched"
    except Exception as e:
        return f"❌ Error launching Spotify: {str(e)}"
